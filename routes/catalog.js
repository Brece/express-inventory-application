...
router.get('/api/category/:id', category_controller.category_detail);
...
router.get('/api/brand/:id', brand_controller.brand_detail);
...
router.get('/api/item/:id', item_controller.item_detail);
...
router.get('/api/iteminstance/:id', iteminstance_controller.iteminstance_detail);
